...
public interface IAnswerRepository extends JpaRepository<Answer,Long> {
    ...
    @Query(value = "select * from answers where question_id = ?", nativeQuery = true)
    Iterable<Answer> getListAnswerByQues(Long question_id);

//    @Query(value = "delete from answers where question_id = ?;",nativeQuery = true)
    void deleteByQuestion(Long question_id);
}
